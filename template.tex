...
% \usepackage[a4paper, landscape, top=1cm, bottom=1cm, left=2cm, right=1cm]{geometry} % 设置页边距
\usepackage[a4paper, landscape, twoside, top=1cm, bottom=1.5cm, inner=1cm, outer=2.5cm]{geometry}
